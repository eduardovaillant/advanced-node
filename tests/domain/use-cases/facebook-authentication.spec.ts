...
describe('FacebookAuthentication', () => {
  ...
  let userAccountRepo: MockProxy<SaveFacebookAccount & LoadUserAccount>
  ...
  it('should throw an AuthenticationError when LoadFacebookUser returns undefined', async () => {
  ...
  it('should rethrow if LoadFacedependencybookUserApi throws', async () => {
